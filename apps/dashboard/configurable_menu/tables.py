...
class MenuItemTable(DashboardTable):
    name = LinkColumn('dashboard:configurable_menu:partner-configurable-menu-item-update', args=[A('pk')])
    ...
    num_children = LinkColumn(
        'dashboard:configurable_menu:partner-configurable-menu-item-details', args=[A('pk')],
